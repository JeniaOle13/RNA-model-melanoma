...
#| warning: false
#| include: false
pathwaysH <- msigdbr(species = "mouse", collection = "H")
...
#| label: PCA 40
#| echo: false
#| fig-cap: "Figure 11. PCA visualization using vst transformation batch corrected counts."
PCA_corr_plot
```
...
```{r fig.height=4, fig.width=5}
#| echo: false
#| fig-cap: "Figure 12. The proportion of explained variance of each component."
prop_corr_plot
```
...
```{r fig.height=5, fig.width=8}
#| echo: false
#| fig-cap: "Figure 13. Dengrogramm of genes and modules."
plot_dendro
```
...
```{r fig.height=6, fig.width=8}
#| echo: false
#| fig-cap: "Figure 14. Number of genes per module."
plot_ngenes
```
...
[Figure 15](figures/module_trait_cor_plot.pdf)

#### Co-expressed modules linked to M group
```{r fig.height=8, fig.width=6}
#| echo: false
#| fig-cap: "Figure 15. Co-expression module association with experimental groups."
module_trait_cor_plot
```
...
```{r fig.height=12, fig.width=6}
#| echo: false
#| fig-cap: "Figure 16. Expression profiles of modules linked to experimental groups."
expression_plot
```
...
#| message: false
#| warning: false
#| fig-cap: "Figure 17. Corelation network of co-expressed genes modules positively and negatively linked to M group."
net_plot
```

#### STRING analysis of modules
[Figure 18](figures/string_1.png)

[Figure 18 - STRING website](https://string-db.org/cgi/network?taskId=bSgjgDkvray5&sessionId=b4tWjn72YI6o)

![Figure 18. PPI network plot obtained using co-expression modules positively linked to M group.](figures/string_1.png)

[Figure 19](figures/cluster_1.png)

![Figure 19. Cluster analysis results obtained using co-expression modules positively linked to M group.](figures/cluster_1.png)

[Figure 20](figures/enrichment_1-1.svg)

![Figure 20. KEGG pathway enrichment in a co-expression network positively associated with group M.](figures/enrichment_1-1.svg)

[Figure 21](figures/enrichment_1-2.svg)

![Figure 21. Reactome pathway enrichment in a co-expression network positively associated with group M.](figures/enrichment_1-2.svg)

[Figure 22](figures/string_2.png)

[Figure 22 - STRING website](https://version-12-0.string-db.org/cgi/network?networkId=bf3KDUz3lYar)

![Figure 22. PPI network plot obtained using co-expression modules negatively linked to M group.](figures/string_2.png)

[Figure 23](figures/cluster_1.png)

![Figure 23. Cluster analysis results obtained using co-expression modules negatively linked to M group.](figures/cluster_1.png)

[Figure 24](figures/enrichment_2-1.svg)

![Figure 24. Gene ontology (Cellular components) pathway enrichment in a co-expression network negatively associated with group M.](figures/enrichment_2-1.svg)

[Figure 25](figures/enrichment_2-2.svg)

![Figure 25. Tissue expression pathway enrichment in a co-expression network negatively associated with group M.](figures/enrichment_2-2.svg)